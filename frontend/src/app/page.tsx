    ...
    <main className={`${opensans.className} px-4 sm:px-0 animate-fade-in`}>
      ...
      <div className="max-w-lg mx-auto">
        <p className="text-left text-sm sm:text-base mb-6">
          im currently a <strong>pre-junior</strong> <span className="text-muted-foreground">(University of Cincinnati has a 5 year engineering program, & pre-junior is like almost over with the third going into the fourth year)</span> studying <strong>computer engineering</strong>.
        </p>
        <p>
         ...
         <span className="block mt-2 mb-2 text-xs sm:text-sm">
            ...
            <br />
            <a href="https://github.com/AmaanBilwar/Reduct-video-editor" target="_blank" className="relative after:absolute after:bottom-0 after:left-0 after:h-[1px] after:w-0 after:bg-current after:transition-all after:duration-300 hover:after:w-full">- building an ai video editor [cursor for video editor]</a>
            <br />
          </span>
        ...
        <p>
         ...
         <span className="block mt-2 text-xs sm:text-sm">
            ...
            • won the <strong>most technically impressive</strong> prize
                  <br />
                  • won the <strong>best use of aws</strong> category 
          </span>
            </span>
      ...
      {isMobile && (
        <div className="mt-8 border-t pt-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a href="/blog" className="bg-primary/10 rounded-md p-3 text-center hover:bg-primary/20 transition-colors">
              Blog
            </a>
