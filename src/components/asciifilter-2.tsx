...
export const AsciiNoiseEffect = ({
  ...
  brightness = 0.79,
  contrast = 1.24,
  seed1 = 2.0421057117961694,
  seed2 = 3.1051358567612652,
  hue = 103,
  sat = 0.68,
  gamma = 0.65,
  vignette = 0.28,
  vignetteSoftness = 1.48,
  glyphSharpness = 0.126,
  bg = [0.09285120108308369, 0.07671670724897504, 0.055256743945007736],
  className,
